...
def clearFolder():
    folder = 'C:\\Users\\vtcst\\Desktop\\Client_Server\\Face\\API\\\Exit'
    ...
    while cap.isOpened():
        ...
        for (x, y, w, h) in faces:
            ...
            if w * h < 100000:
                ...
                filepath = f"C:\\Users\\vtcst\\Desktop\\Client_Server\\Face\\API\\Exit\\{image_name}.png"
                ...
                if name != "":
                    ...
                    # send msg to SERVER
                    data = {'status': True, 'memberID': id}
                    res = requests.post('http://127.0.0.1:3000/createNewOrder', json=data)
